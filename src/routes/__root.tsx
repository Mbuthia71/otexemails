...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "React Email template authoring and render endpoint" },
      { property: "og:title", content: "Email Template Studio" },
      { property: "og:description", content: "React Email template authoring and render endpoint" },
